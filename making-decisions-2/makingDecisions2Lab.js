...
var someNum = myFavoriteNumbers.splice(4,1)
console.log(someNum)
...
if (myFavoriteNumbers.length >= 7){
  var someNum = myFavoriteNumbers.splice(6,1)
console.log(someNum)
} else {console.log("There are not enough elements in this array' to the console.")}
